				...
				<Controller
					...
					render={({field}) => (
						<Form.Group className="mb-3">
							...
							/>
							{errors.title && <div className="invalid-feedback text-danger">{errors.title.message}</div>}
						</Form.Group>
					)}
				/>
				<Controller
					...
					render={({field}) => (
						<Form.Group className="mb-3">
							...
							/>
							{errors.description && (
								<div className="invalid-feedback text-danger">{errors.description.message}</div>
							)}
						</Form.Group>
					)}
				/>
				<Controller
					...
					render={({field}) => (
						<Form.Group className="mb-3">
							...
							/>
							{errors.price && <div className="invalid-feedback text-danger">{errors.price.message}</div>}
						</Form.Group>
					)}
				/>
				<Form.Group className="mb-3">
